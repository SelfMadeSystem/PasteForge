...
public class Colour {
    public static class RGB {
        ...
        public boolean approxEquals(Object o) {
            ...
            if (o == null || getClass() != o.getClass()) return false;
            RGB rgb = (RGB) o;
            return MathUtil.approxEquals(rgb.r, r, 0.002) &&
              MathUtil.approxEquals(rgb.g, g, 0.002) &&
              MathUtil.approxEquals(rgb.b, b, 0.002);
        }
    ...
    public static class HSV {
        ...
        public boolean approxEquals(Object o) {
            ...
            if (o == null || getClass() != o.getClass()) return false;
            HSV hsv = (HSV) o;
            return MathUtil.approxEquals(hsv.h, h, 1) &&
              MathUtil.approxEquals(hsv.s, s, 0.002) &&
              MathUtil.approxEquals(hsv.v, v, 0.002);
        }
    ...
    public static HSV rgb2hsv(Color in) {
        return rgb2hsv(new RGB(in));
    }
